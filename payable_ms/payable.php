...
$fellow_count = 0;
//取得指定管理人數
$pjmyfellow_row = getkeyvalue2($site_db . "_info", "pjmyfellow", "web_id = '$web_id' and project_id = '$project_id' and auth_id = '$auth_id' and pro_id = 'payable'", "count(*) as fellow_count");
...
$pjItemManager = false;
//檢查是否為指定管理人
$pjmyfellow_row = getkeyvalue2($site_db . "_info", "pjmyfellow", "web_id = '$web_id' and project_id = '$project_id' and auth_id = '$auth_id' and pro_id = 'payable' and member_no = '$memberID'", "count(*) as enable_count");
	...
	$(document).ready(function() {
		$('#db_table').dataTable( {
			...
			"fnRowCallback": function( nRow, aData, iDisplayIndex ) {
				...
				var url3 = "openfancybox_edit('/index.php?tb=payable&auto_seq="+aData[5]+"&project_id=$project_id&auth_id=$auth_id&fm=pjattach','96%','96%','myDraw();');";
